                            ...
                            return Object.keys(groupedData).map((group, groupIndex) => {
                                ...
                                return (
                                    ...
                                    <div key={groupIndex} className="row mb-6 w-full">
                                        ...
                                        {/* Keterangan yang muncul sekali di bawah nama kelompok */}
                                        <div className="font-light text-left text-xs mb-4">
                                            ( {keterangan} )
                                        </div>
                                                ...
                                                return (
                                                    <div className="small-box bg-info">
                                                        <div className="inner">
                                                            <p>{item.sensorName}</p>
                                                            {(() => {
                                                                const { display, isRed } = getDisplayValue(item.sensorName, value, anomaly);
                                                                return (
                                                                    <h4 className={`text-center text-2xl ${isRed ? 'text-red' : ''} mb-0`}>
                                                                        {display}
                                                                    </h4>
                                                                );
                                                            })()}
                                                        </div>
                                                        <Link to={detailUrl} key={index} className="small-box-footer">
